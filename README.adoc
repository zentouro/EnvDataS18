...
.Approximate Course Schedule, 15% each column
[width="60%", options="header",cols="4", format="csv"]
| ======
...
,Final exam period (TBD),Final project presentation, NA
,5/11/18,Take-home final exam due, NA
|======
